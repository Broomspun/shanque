...
<head>
	...
	<?php  } ?> 
	<?php  if(IMS_FAMILY != 'x') { ?> 
		- Powered by shanque.zhangshuoyin.cn 
	<?php  } ?>
	</title>
	...
	<meta name="keywords" content="<?php  if(empty($_W['page']['keywords'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>山雀,微信,微信公众平台,shanque.zhangshuoyin.cn<?php  } ?><?php  } else { ?><?php  echo $_W['page']['keywords'];?><?php  } ?>" />
	<meta name="description" content="<?php  if(empty($_W['page']['description'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>公众平台自助引擎（shanque.zhangshuoyin.cn），简称山雀，山雀是一款免费开源的微信公众平台管理系统，是国内最完善移动网站及移动互联网技术解决方案。<?php  } ?><?php  } else { ?><?php  echo $_W['page']['description'];?><?php  } ?>" />
