...
<head>
    ...
    <script src="../addons/wn_storex/template/shanque/mobile/js/jquery-1.11.2.mim.js" type="text/javascript"></script>
    <script src="../addons/wn_storex/template/shanque/mobile/js/bootstrap.js" type="text/javascript"></script>
            ...
            <div class="info_style">
                <div id="detailed_content">
                    ...
                    <div class="container">
                        ...
                        <p class="detaild_price"><?php echo $detail['cprice']; ?>元/天 <span class="deposit">免佣金</span>
                        </p>
                    </div>
                    <?php if($detail['uid']==$_W['fans']['uid']) {?>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Setting Room Price & Status</h4>
                                    </div>
                    ...
                    <div class="account-box">
                        <h2 class="account-title">
                            ...
                            <ul class="clearfix data_title">
                                ...
                                <li class=" f-riqi">排房日期<span class="f-year">2017</span>年<span class="f-month">1</span>月
                                </li>
            ...
            <div class="">
                ...
                <div class="fd_user clearfix">
                    <div class="user_Avatar">
                        <em class="Avatar_img"><img src="../addons/wn_storex/template/shanque/mobile/images/user.jpg"
                                                    width="60%"></em>
                ...
                <div class="s-detail">
                    <div id="leftTabBoxs">
                        <div class="hd">
                            <ul>
                                <li>详情</li>
                                <li>评价（<span class="review-counts"><?php echo count($reviews); ?></span>）</li>
                                <li>周边</li>
                            </ul>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <form class="form-horizontal" id="review-form" method="post">
                                                    <input type="hidden" name="uid"
                                                           value="<?php echo $_W['fans']['uid']; ?>"/>
                                                    <input type="hidden" name="roomid"
                                                           value="<?php echo $_GPC['id']; ?>"/>
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-1 col-sm-10 col-xs-offset-1 col-xs-10">
                                                            <textarea required name="review-desc"
                                                                      placeholder="Leave a review" class="form-control"
                                                                      rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-1 col-sm-10 col-xs-offset-1 col-xs-10">
                                                            <button type="submit"
                                                                    class="text-center col-xs-12 btn btn-default">Submit
                                                            </button>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <ul class="clearfix">
                                        <div class="clearfix relative">
                                            <li class="Product_Image">
                                                <div class="wrap_score"><span class="ribbon6">4.5分</span></div>
                                                <a href="#"><img
                                                            src="../addons/wn_storex/template/shanque/mobile/images/p_1.jpg"
                                                            width="100%"></a></li>
