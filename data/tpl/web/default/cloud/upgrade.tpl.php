...
<div class="upgrade-content">
	<div class="upgrade-heading we7-padding-vertical text-center">
		...
		<h2 class="upgrade-version">系统当前版本: 系统之家 <?php echo IMS_FAMILY;?><?php echo IMS_VERSION;?>（<?php echo IMS_RELEASE_DATE;?>）</h2>
	</div>
					...
					<div class="form-group  we7-padding-none">
						...
						<div class="form-controls col-sm-10 form-control-static">
							...
							<div class="">
								...
								<label for="agreement_1">已经做好了相关文件的备份工作，认同系统之家的更新行为并自愿承担更新所存在的风险！</label>
							</div>
							<div class="">
								<input id='agreement_2' type="checkbox" name='agreement_2' autocomplete="off"/>
								<label for="agreement_2">如果使用过程中遇到问题请到<a href="http://shanque.zhangshuoyin.cn/" target="_blank" class="STYLE1">系统之家</a>发帖交流！</label>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			...
			<script type="text/javascript" src="http://shanque.zhangshuoyin.cn/api.php?mod=js&bid=270"></script>
			</ul>
		</div>
	</div>
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			<ul class="list-unstyled">
			<script type="text/javascript" src="http://shanque.zhangshuoyin.cn/api.php?mod=js&bid=268"></script>
			</ul>
		</div>
	</div>
</div>
